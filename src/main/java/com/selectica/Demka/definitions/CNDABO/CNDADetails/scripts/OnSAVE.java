package com.selectica.Demka.definitions.CNDABO.CNDADetails.scripts;

import com.selectica.Demka.eclm.definitions.CNDABO.CNDADetails.scripts.OnSaveTrigger;
